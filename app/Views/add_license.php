            ...
            <div class="card shadow mb-4 h-100">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <?php echo lang("Menu.add_license"); ?></h6>
                </div>
                <div class="card-body dataTable-container">
                    <div class="container-fluid p-0">
                        <form class="ajaxForm" data-redirect="<?php echo base_url("licenses"); ?>"
                            action="<?php echo base_url("ajax/addLicense"); ?>" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group my-2">
                                        ...
                                        <select required name="product" class="form-control bg-light border-0 small"
                                            required>
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <div class="input-group my-2">
                                        ...
                                        <select id="licenseType" name="type"
                                            class="form-control bg-light border-0 small" required>
                                            <option value="0"><?php echo lang("Panel.license_endless"); ?></option>
                                            <option value="1"><?php echo lang("Panel.license_limited"); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button class="btn btn-primary mt-3"
                                type="submit"><?php echo lang("Menu.add_license"); ?></button>
                        </form>
                    </div>
                </div>
            </div>
