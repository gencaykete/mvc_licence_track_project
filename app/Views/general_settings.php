            ...
            <div class="card shadow mb-4 h-100">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <?php echo lang("Menu.general_settings"); ?></h6>
                </div>
                <div class="card-body dataTable-container">
                    <div class="container-fluid p-0">
                        <form class="ajaxForm" data-redirect="<?php echo base_url("settings"); ?>"
                            action="<?php echo base_url("ajax/updateSettings"); ?>" method="post">
                            <ul class="nav nav-tabs" id="settingsTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="panel-tab" data-toggle="tab" href="#panel" role="tab"
                                        aria-controls="panel"
                                        aria-selected="true"><?php echo lang("Menu.panel_settings"); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="warning-tab" data-toggle="tab" href="#warning" role="tab"
                                        aria-controls="warning"
                                        aria-selected="true"><?php echo lang("Menu.warning_page"); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="telegram-tab" data-toggle="tab" href="#telegram" role="tab"
                                        aria-controls="telegram"
                                        aria-selected="false"><?php echo lang("Menu.telegram_settings"); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="mail-tab" data-toggle="tab" href="#mail" role="tab"
                                        aria-controls="mail"
                                        aria-selected="false"><?php echo lang("Menu.mail_settings"); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="sms-tab" data-toggle="tab" href="#sms" role="tab"
                                        aria-controls="sms"
                                        aria-selected="false"><?php echo lang("Menu.sms_settings"); ?></a>
                                </li>
                            </ul>
                            <div class="mt-3 tab-content" id="settingsTabContent">
                                <div class="tab-pane fade show active" id="panel" role="tabpanel"
                                    aria-labelledby="panel-tab">

                                    <div class="row">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.panel_language"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-flag"></i></span>
                                                </div>
                                                <select name="language" class="form-control bg-light border-0 small"
                                                    required>
                                                    <option value="tr"
                                                        <?php echo language == "tr" ? "selected" : ""; ?>>
                                                        Türkçe</option>
                                                    <option value="en"
                                                        <?php echo language == "en" ? "selected" : ""; ?>>
                                                        English</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.panel_timezone"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-clock"></i></span>
                                                </div>
                                                <select name="timezone" class="form-control bg-light border-0 small"
                                                    required>
                                                    <?php for($i = 0; $i < count($timezones); $i++): ?>
                                                    <option value="<?php echo array_keys($timezones)[$i]; ?>"
                                                        <?php echo timezone == array_keys($timezones)[$i] ? "selected" : ""; ?>>
                                                        <?php echo $timezones[array_keys($timezones)[$i]]; ?></option>
                                                    <?php endfor; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.telegram_notifications"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fab fa-telegram"></i></span>
                                                </div>
                                                <select name="telegram_notifications"
                                                    class="form-control bg-light border-0 small" required>
                                                    <option value="0"
                                                        <?php echo telegram_notifications == "0" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.deactive"); ?></option>
                                                    <option value="1"
                                                        <?php echo telegram_notifications == "1" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.active"); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.mail_notifications"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                ...
                                                <select name="mail_notifications"
                                                    class="form-control bg-light border-0 small" required>
                                                    <option value="0"
                                                        <?php echo mail_notifications == "0" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.deactive"); ?></option>
                                                    <option value="1"
                                                        <?php echo mail_notifications == "1" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.active"); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.sms_notifications"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-sms"></i></span>
                                                </div>
                                                <select name="sms_notifications"
                                                    class="form-control bg-light border-0 small" required>
                                                    <option value="0"
                                                        <?php echo sms_notifications == "0" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.deactive"); ?></option>
                                                    <option value="1"
                                                        <?php echo sms_notifications == "1" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.active"); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="warning" role="tabpanel" aria-labelledby="warning-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.warning_page_design"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-file"></i></span>
                                                </div>
                                                <select name="warning_page" class="form-control bg-light border-0 small"
                                                    required>
                                                    <option value="1"
                                                        <?php echo warning_page == "1" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.design"); ?> 1</option>
                                                    <option value="2"
                                                        <?php echo warning_page == "2" ? "selected" : ""; ?>>
                                                        <?php echo lang("Panel.design"); ?> 2</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.warning_extra_header"); ?>:</span>
                                            <textarea style="height:125px" name="warning_extra_header"
                                                class="my-2 form-control bg-light"><?php echo warning_extra_header; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.warning_extra_footer"); ?>:</span>
                                            <textarea style="height:125px" name="warning_extra_footer"
                                                class="mt-2 form-control bg-light"><?php echo warning_extra_footer; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="telegram" role="tabpanel" aria-labelledby="telegram-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.telegram_bot_token"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-robot"></i></span>
                                                </div>
                                                <input value="<?php echo telegram_bot_token; ?>" type="text"
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.telegram_chat_id"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-paper-plane"></i></span>
                                                </div>
                                                <input value="<?php echo telegram_chat_id; ?>" type="text"
                                ...
                                <div class="tab-pane fade" id="mail" role="tabpanel" aria-labelledby="mail-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.notification_mail"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-envelope"></i></span>
                                                </div>
                                                <input value="<?php echo notification_mail; ?>" type="text"
                                                    name="notification_mail"
                                                    class="form-control bg-light border-0 small">
                                            </div>
                                            <small
                                                class="mb-1"><?php echo lang("Panel.notification_mail_text"); ?></small>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.smtp_host"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-server"></i></span>
                                                </div>
                                                <input value="<?php echo smtp_host; ?>" type="text" name="smtp_host"
                                                    class="form-control bg-light border-0 small">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.smtp_user"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-user"></i></span>
                                                </div>
                                                <input value="<?php echo smtp_user; ?>" type="text" name="smtp_user"
                                                    class="form-control bg-light border-0 small">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.smtp_password"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-key"></i></span>
                                                </div>
                                                <input value="<?php echo smtp_password; ?>" type="text"
                                                    name="smtp_password" class="form-control bg-light border-0 small">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.smtp_port"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-sort-numeric-down-alt"></i></span>
                                                </div>
                                                <input value="<?php echo smtp_port; ?>" type="text" name="smtp_port"
                                                    class="form-control bg-light border-0 small">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="sms" role="tabpanel" aria-labelledby="sms-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.notification_phone"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-phone"></i></span>
                                                </div>
                                                <input value="<?php echo notification_phone; ?>" type="text"
                                                    name="notification_phone"
                                                    class="form-control bg-light border-0 small">
                                            </div>
                                            <small
                                                class="mb-1"><?php echo lang("Panel.notification_phone_text"); ?></small>
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-6">
                                            <span><?php echo lang("Panel.sms_company"); ?>:</span>
                                            <div class="input-group my-2">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text border-0 bg-primary text-light"><i
                                                            class="fas fa-sms"></i></span>
                                                </div>
                                                <select name="sms_company" class="form-control bg-light border-0 small"
                                                    required>
                                                    <option value="twilio"
                                                        <?php echo sms_company == "twilio" ? "selected" : ""; ?>>
                                                        Twilio</option>
                                                    <option value="netgsm"
                                                        <?php echo sms_company == "netgsm" ? "selected" : ""; ?>>
                                                        Netgsm</option>
                                                    <option value="iletimerkezi"
                                                        <?php echo sms_company == "iletimerkezi" ? "selected" : ""; ?>>
                                                        İletimerkezi</option>
                                                    <option value="mutlucell"
                                                        <?php echo sms_company == "mutlucell" ? "selected" : ""; ?>>
                                                        Mutlucell</option>
                                                    <option value="vatansms"
                                                        <?php echo sms_company == "vatansms" ? "selected" : ""; ?>>
                                                        Vatansms</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sms_company" id="sms_company_twilio">
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.twilio_account_sid"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-user"></i></span>
                                                    </div>
                                                    <input value="<?php echo twilio_account_sid; ?>" type="text"
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.twilio_auth_token"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-key"></i></span>
                                                    </div>
                                                    <input value="<?php echo twilio_auth_token; ?>" type="text"
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.twilio_phone_number"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-pencil-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo twilio_phone_number; ?>" type="text"
                                    ...
                                    <div class="sms_company" id="sms_company_netgsm">
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.netgsm_username"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-user"></i></span>
                                                    </div>
                                                    <input value="<?php echo netgsm_username; ?>" type="text"
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.netgsm_password"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-key"></i></span>
                                                    </div>
                                                    <input value="<?php echo netgsm_password; ?>" type="text"
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.netgsm_header"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-pencil-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo netgsm_header; ?>" type="text"
                                                        name="netgsm_header"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                    ...
                                    <div class="sms_company" id="sms_company_iletimerkezi">
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.iletimerkezi_username"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-user"></i></span>
                                                    </div>
                                                    <input value="<?php echo iletimerkezi_username; ?>" type="text"
                                                        name="iletimerkezi_username"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.iletimerkezi_password"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-key"></i></span>
                                                    </div>
                                                    <input value="<?php echo iletimerkezi_password; ?>" type="text"
                                                        name="iletimerkezi_password"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.iletimerkezi_sender"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-pencil-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo iletimerkezi_sender; ?>" type="text"
                                                        name="iletimerkezi_sender"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sms_company" id="sms_company_mutlucell">
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.mutlucell_username"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-user"></i></span>
                                                    </div>
                                                    <input value="<?php echo mutlucell_username; ?>" type="text"
                                                        name="mutlucell_username"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.mutlucell_password"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-key"></i></span>
                                                    </div>
                                                    <input value="<?php echo mutlucell_password; ?>" type="text"
                                                        name="mutlucell_password"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.mutlucell_header"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-pencil-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo mutlucell_header; ?>" type="text"
                                                        name="mutlucell_header"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sms_company" id="sms_company_vatansms">
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.vatansms_user_number"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-sort-numeric-down-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo vatansms_user_number; ?>" type="text"
                                                        name="vatansms_user_number"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.vatansms_username"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-user"></i></span>
                                                    </div>
                                                    <input value="<?php echo vatansms_username; ?>" type="text"
                                                        name="vatansms_username"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.vatansms_password"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-key"></i></span>
                                                    </div>
                                                    <input value="<?php echo vatansms_password; ?>" type="text"
                                                        name="vatansms_password"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-1">
                                            <div class="col-md-6">
                                                <span><?php echo lang("Panel.vatansms_sender"); ?>:</span>
                                                <div class="input-group my-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text border-0 bg-primary text-light"><i
                                                                class="fas fa-pencil-alt"></i></span>
                                                    </div>
                                                    <input value="<?php echo vatansms_sender; ?>" type="text"
                                                        name="vatansms_sender"
                                                        class="form-control bg-light border-0 small">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <button type="submit" class="btn btn-primary mt-3">
                                <?php echo lang("Panel.update_settings"); ?>
                            </button>
                        </form>
                    </div>
                </div>
...
<script>
$(function() {
    $("select[name=sms_company]").change(function() {
        $(".sms_company").hide();
        $("#sms_company_" + $("select[name=sms_company]").val()).show();
    });
    $("select[name=sms_company]").change();
})
</script>